...
namespace HousingFinanceInterimApi.V1.Factories
{
    ...
    /// </summary>
    public static class CurrentRentPositionFactory
    {
        ...
        public static IList<CurrentRentPosition> ToEntity(IMapper autoMapper, IList<CurrentRentPositionDomain> domainObjects)
            => domainObjects.Select(autoMapper.Map<CurrentRentPosition>).ToList();
