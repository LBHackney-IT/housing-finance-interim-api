...
namespace HousingFinanceInterimApi.V1.Controllers
{
    ...
    public class HousingFinanceInterimApiController : BaseController
    {
        private readonly IGetAllUseCase _getAllUseCase;
        private readonly IGetByIdUseCase _getByIdUseCase;
        public HousingFinanceInterimApiController(IGetAllUseCase getAllUseCase, IGetByIdUseCase getByIdUseCase)
        {
