...
namespace HousingFinanceInterimApi.V1.Gateways.Interface
{
    ...
    /// </summary>
    public interface IUPCashDumpFileNameGateway
    {
        ...
        public Task<UPCashDumpFileNameDomain> CreateAsync(string fileName, bool isSuccess = false);
        ...
        public Task<UPCashDumpFileNameDomain> GetProcessedFileByName(string fileName);
