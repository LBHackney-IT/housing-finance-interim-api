...
{
    public class SqlServerRdsContextFixture : IDatabaseContextFixture, IDisposable
    {
        ...
        public SqlServerRdsContextFixture(string connectionString)
        {
